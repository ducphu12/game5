...
var MyFish = {
    ...
    init: function() {
        ...
        this.fish_left_image.src = "https://github.com/LuongVinhKhang/Feeding-Frenzy-HTML5-Canvas/blob/master/images/fish_left.gif?raw=true"; // 200x123
        this.fish_right_image = new Image();
        this.fish_right_image.src = "https://github.com/LuongVinhKhang/Feeding-Frenzy-HTML5-Canvas/blob/master/images/fish_right.gif?raw=true"; // 200x123
        this.width = 186 / 2;
        this.height = 85 / 2;
    },
...
// marine
var marines_source = [
    "https://github.com/LuongVinhKhang/Feeding-Frenzy-HTML5-Canvas/blob/master/images/marines/star.png?raw=true", //200x213            // 0
    "https://github.com/LuongVinhKhang/Feeding-Frenzy-HTML5-Canvas/blob/master/images/marines/fish_1_left.png?raw=true", // 200x100    // 1
    "https://github.com/LuongVinhKhang/Feeding-Frenzy-HTML5-Canvas/blob/master/images/marines/fish_1_right.png?raw=true",
    "https://github.com/LuongVinhKhang/Feeding-Frenzy-HTML5-Canvas/blob/master/images/marines/fish_2_left.png?raw=true", // 200x106    // 3
    "https://github.com/LuongVinhKhang/Feeding-Frenzy-HTML5-Canvas/blob/master/images/marines/fish_2_right.png?raw=true",
    "https://github.com/LuongVinhKhang/Feeding-Frenzy-HTML5-Canvas/blob/master/images/marines/fish_3_left.png?raw=true", // 200x153    // 5
    "https://github.com/LuongVinhKhang/Feeding-Frenzy-HTML5-Canvas/blob/master/images/marines/fish_3_right.png?raw=true",
    "https://github.com/LuongVinhKhang/Feeding-Frenzy-HTML5-Canvas/blob/master/images/marines/fish_4_left.png?raw=true", // 200x86     // 7
    "https://github.com/LuongVinhKhang/Feeding-Frenzy-HTML5-Canvas/blob/master/images/marines/fish_4_right.png?raw=true",
...
function setMousePosition(e) {
    ...
    if (global_mouse_x < mouse_x) {
        MyFish.direction = 'R';
        document.getElementById('cursorID').src = 'https://github.com/LuongVinhKhang/Feeding-Frenzy-HTML5-Canvas/blob/master/images/fish_right.gif?raw=true'
    } else {
        MyFish.direction = 'L';
        document.getElementById('cursorID').src = 'https://github.com/LuongVinhKhang/Feeding-Frenzy-HTML5-Canvas/blob/master/images/fish_left.gif?raw=true'
    }
...
function update() {
    ...
    if (isWin) {
        ...
        var img = new Image();
        img.src = "https://github.com/LuongVinhKhang/Feeding-Frenzy-HTML5-Canvas/blob/master/images/control/win.png?raw=true";
        img.onload = function() {
    ...
    if (isGameOver) {
        ...
        var img = new Image();
        img.src = "https://github.com/LuongVinhKhang/Feeding-Frenzy-HTML5-Canvas/blob/master/images/control/gameover.jpg?raw=true";
        img.onload = function() {
            context_main.drawImage(img, (MyCanvas.canvas_width - img.width) / 2,
                (MyCanvas.canvas_height - img.height) / 2);
        };
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// run
background.src = "https://github.com/LuongVinhKhang/Feeding-Frenzy-HTML5-Canvas/blob/master/images/background_level1.jpg?raw=true";
